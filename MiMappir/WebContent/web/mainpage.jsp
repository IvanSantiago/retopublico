...
<head>
    ...
    <link rel="stylesheet" type="text/css" href="../ext-3.2.1/examples/ux/css/CenterLayout.css" />
    ...
    <!-- extensions -->
    <script language="JavaScript" type="text/javascript" src="../ext-3.2.1/examples/ux/CenterLayout.js"></script>
    <script language="JavaScript" type="text/javascript" src="../ext-3.2.1/examples/ux/RowLayout.js"></script>
    <script language="JavaScript" type="text/javascript" src="../ext-3.2.1/examples/ux/TabCloseMenu.js"></script>
	<!-- <script language="JavaScript" type="text/javascript" src="../ext-3.2.1/examples/shared/examples.js"></script> -->
	
    <!-- page specific -->
    <script language="JavaScript" type="text/javascript" src="./layouts/basic.js"></script>
    <script language="JavaScript" type="text/javascript" src="./layouts/custom.js"></script>
    <script language="JavaScript" type="text/javascript" src="./layouts/combination.js"></script>
    <!-- <script language="JavaScript" type="text/javascript" src="../js/tabs-adv.js"></script> -->
