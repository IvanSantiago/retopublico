...
public class QOSTELQUADATA {
	...
	public QOSTELQUADATA() {
	}
	
	public QOSTELQUADATA(Double dlongitud, Double dlatitud) {
	...
	public QOSTELQUADATA(Double dlongitud, Double dlatitud, Double altitude) {
		this.dlongitud = dlongitud;
		this.dlatitud = dlatitud;
	...
	public QOSTELQUADATA(String coordinates) {
	...
	public boolean equals(Object obj) {
		...
		if (!(obj instanceof QOSTELQUADATA)) {
			return false;
		}
		QOSTELQUADATA other = (QOSTELQUADATA) obj;
	...
	public QOSTELQUADATA withdlongitud(Double dlongitud) {
		setDlongitud(dlongitud);
		return this;
	}

	public QOSTELQUADATA withdlatitud(Double dlatitud) {
		setDlatitud(dlatitud);
		return this;
	}

	public QOSTELQUADATA withAltitude(Double altitude) {
		setD_altitude(altitude);
		return this;
	}

	public QOSTELQUADATA clone() {
		QOSTELQUADATA copy;
		try {
			copy = (QOSTELQUADATA) super.clone();
