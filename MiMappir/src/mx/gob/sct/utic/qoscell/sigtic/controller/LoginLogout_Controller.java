...
@Controller
@RequestMapping("/auth") 
public class LoginLogout_Controller {
	/**
	 ...
	 * @return the name of the JSP page
	 */
	@RequestMapping(value = "/denied.action", method = RequestMethod.GET)
