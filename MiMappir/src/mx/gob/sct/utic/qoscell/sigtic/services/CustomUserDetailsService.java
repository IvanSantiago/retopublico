...
public class CustomUserDetailsService implements UserDetailsService{
	...
	public UserDetails loadUserByUsername(String username)
		...
		try {
			...
			List<USUARIOS> registros = USUARIOS_Service.getUsuario(username);
			...
			user = new User(dbUser.getLOGIN(), dbUser.getPASS(), true, true,
	...
	@Autowired
	public void setMenuService(USUARIOS_Service service) {
		this.USUARIOS_Service = service;
	}
}