...
<jsp:include page="modal/enviarComentario.jsp" />
...
<div id="enviarComentarioContent" class="modal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
    <form id="#enviarComentarioForm">
        <div class="modal-dialog" style="width: 520px;">
            <div class="modal-content">
                ...
                <div class="modal-body" style="overflow-y: scroll;">
                    <div class="col-xs-12"><b></b><i>Enviar un comentario <span id="modalenviarComentarioLugar"></span></i></b></div>
                    <br>
                    <span class="label-warning col-xs-12 ui-helper-hidden" style="padding:4px;" id="enviarComentarioError"></span>
                    <input id="incidente_titulo" name="incidente_titulo" type="hidden">

                    <div class="row">
                        <label for="incidente_nombre" class="col-xs-4">Cuenta Facebook:</label>
                        <div class="col-xs-8">
                    ...
                    <div class="row">
                        <label class="col-xs-4">Categoria del comentario: <i>*</i></label>
                        <div class="col-xs-8">
                            <ul class="sct-select pull-right/var/www/SCT_MAPPIR/web/modal/enviarComentario.jsp">
                    ...
                    <div class="row">
                        <label for="incidente_descripcion" class="col-xs-4">Comentario: <i>*</i></label>
                        <div class="col-xs-8">
                        <textarea id="incidente_descripcion" cols="40" rows="5"
                                  placeholder="Describe lo que has descubierto en este punto"
                ...
                <div class="modal-footer" style="width:100%; padding-top: 8px;margin-top: 0px;">
                    ...
                    <br>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="MappirInterface.instance.enviarComentario()">
                        Agregar imagenes
                    </button>
                    <button type="button" class="btn btn-primary" data-dismiss="modal" onclick="MappirInterface.instance.enviarComentario()">
                        Compartir
